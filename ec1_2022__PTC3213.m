%%%% ///////////////////////////////////////////////////////////////////////////
%%%%        PTC3213 - EC1 - Out/2022 - DIFERENCAS FINITAS
%%%%
%%%%    11806830 Deise de Andrade Carbonaro
%%%%    11375225 Ivan da Cruz Nunes de Moraes  
%%%%    
%%%%                           
%%%%
%%%%  /////////////////////////////////////////////////////////////////////////
...
pkg load matgeom; % executar este comando apenas 1 vez, apos abrir o Octave
warning ("on");
clc;
...
NUSP = 11806830  ; % NUSP do 1o aluno (ordem alfab.)%
a= 10; # dimensoes em cm
b= 6;
c= 3;
d= b-3;
g= 4;
...
%%%
%%%
deltaV=   DeltaV/floor(ntubos) ;
V=0:deltaV:Vmax;
colormap jet;
contour(x,y, Dual_new, V);
axis('equal');
strusp=sprintf('%d',NUSP);
titulo=['Mapa de Quadrados Curvilineos (EC1 2022) - ', strusp, ' - ', date()];
title(titulo);
hold off
%%%
